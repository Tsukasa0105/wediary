...
ActiveRecord::Schema.define(version: 20_210_221_091_956) do
  create_table 'events', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci',
                         force: :cascade do |t|
    t.bigint 'user_id'
    t.bigint 'group_id'
    t.string 'image'
  ...
  create_table 'favorites', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci',
                            force: :cascade do |t|
    t.bigint 'user_id'
    t.bigint 'memo_id'
    t.datetime 'created_at', null: false
  ...
  create_table 'group_to_users', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci',
                                 force: :cascade do |t|
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
  ...
  create_table 'initial_pay_relationships',
  ...
  create_table 'maps', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci',
                       force: :cascade do |t|
    t.text 'address'
    t.float 'latitude'
    t.float 'longitude'
  ...
  create_table 'memos', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci',
                        force: :cascade do |t|
    t.string 'title'
    t.text 'content'
    t.bigint 'event_id'
  ...
  create_table 'pay_records', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci',
                              force: :cascade do |t|
    t.string 'name'
    t.integer 'amount'
    t.datetime 'created_at', null: false
  ...
  create_table 'pay_relationships', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci',
                                    force: :cascade do |t|
    t.bigint 'user_id'
    t.bigint 'pay_record_id'
    t.datetime 'created_at', null: false
  ...
  create_table 'photos', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci',
                         force: :cascade do |t|
    t.bigint 'group_id'
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
  ...
  create_table 'relationships', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci',
                                force: :cascade do |t|
    t.bigint 'user_id'
    t.bigint 'follow_id'
    t.datetime 'created_at', null: false
  ...
  create_table 'user_to_groups', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci',
                                 force: :cascade do |t|
    t.bigint 'group_id'
    t.bigint 'user_id'
    t.datetime 'created_at', null: false
