  ...
  def notification_form(notification)
    ...
    when 'new_event'
      tag.a(@visiter.name, href: user_path(@visiter),
                           style: 'font-weight: bold;') + 'が' + tag.a(@group.name, href: group_path(@group),
                                                                                   style: 'font-weight: bold;') + 'に' + tag.a('新規イベント', href: group_event_path(@group, @event),
                                                                                                                                        style: 'font-weight: bold;') + 'を作成しました'
    when 'edit_event'
